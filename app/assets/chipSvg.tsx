...
const ChipSVG: React.FC<MyComponentProps> = (props) => {

    return(
        <svg fill={props.color} height="100px" width="100px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" 
            viewBox="0 0 296.477 296.477" xmlSpace="preserve">
        <g>
            <path d="M244.63,35.621c-21.771-18.635-47.382-29.855-73.767-33.902C121.871-5.797,70.223,11.421,35.622,51.847
                ...
                <text fill="white" x="50%" y="52%" dominantBaseline="middle" textAnchor="middle" fontSize="50">${props.value}</text>
